...
from tests.heart.conftest import get_workdir, clean_directory

from ansys.heart.preprocessor.mesh.mesher import mesh_from_good_quality_surfaces
...
def test_meshing_from_clean():
    ...
    mesh_from_good_quality_surfaces(
        model,
        write_dir,
        mesh_file,
    )
...
# # write_dir = os.path.join(get_workdir(), "mesher")
# write_dir = write_dir = r"D:\development\pyheart-lib\pyheart-lib\tests\heart\workdir_tests\mesher"
...
#     mesh_from_good_quality_surfaces,
#     mesh_from_good_quality_surfaces_prime,
# )
# from ansys.heart.preprocessor.mesh.fluenthdf5 import FluentMesh
