...
def test_contour_exporter():
    ...
    assert contours[0].GetPoint(0) == (7.273597903198675, 128.824467818063, 387.9997416596942)
    assert contours[1].GetPoint(0) == (7.254521621126342, 128.83922762291593, 388.01083324324804)
...
def test_lvls():
    ...
    assert np.allclose(
        p2, np.array([[70.7569, 72.7259, 351.93], [70.79526416, 72.73520587, 351.97354634]])
    )
