...
try:
    ...
    warnings.warn("wget not installed but requried. Please install by: pip install wget")
...
def download_case(
    ...
    if database not in VALID_DATABASES:
        raise ValueError("Databse not valid, please specify valid database: %s" % VALID_DATABASES)
