...
@pytest.mark.parametrize(
    "stl_file",
    [
        "caps_Left_ventricle.stl",
        "caps_Right_ventricle.stl",
        "caps_Left_atrium.stl",
        "caps_Right_atrium.stl",
        "closed_volume_left_ventricle.stl",
        "closed_volume_right_ventricle.stl",
        "closed_volume_left_atrium.stl",
        "closed_volume_right_atrium.stl",
    ],
)
def test_stl_consistency(stl_file):
    ...
    stl_path_ref = os.path.join(get_assets_folder(), "reference_models", "FourChamber", stl_file)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "points_endocardium_left_atrium.vtk",
        "points_endocardium_right_atrium.vtk",
        "points_epicardium_left_ventricle.vtk",
        "points_epicardium_right_ventricle.vtk",
        "points_epicardium_left_atrium.vtk",
        "points_epicardium_right_atrium.vtk",
        "points_epicardium-septum_left_ventricle.vtk",
    ],
)
def test_vtk_consistency(vtk_file):
    vtk_path = os.path.join(output_dir, vtk_file)
    vtk_path_ref = os.path.join(get_assets_folder(), "reference_models", "FourChamber", vtk_file)
