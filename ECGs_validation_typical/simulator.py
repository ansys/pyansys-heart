...
# param_file_path = r'D:\xuhu\pyansys-heart\examples\SensitivityAnalysis_Sigma\scenarios\sigmaX.csv'
...
'''
# default sigmaX: 0.5
simulator.settings.electrophysiology.material.myocardium["sigma_fiber"] = Quantity(1.75, "mS/mm")
# simulator.settings.electrophysiology.material.beam["sigma"] = Quantity(float(row_data["sigmaX"])*6, "mS/mm")
