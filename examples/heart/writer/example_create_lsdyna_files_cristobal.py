...
if __name__ == "__main__":
    ...
    if "LeftVentricle" in models_to_run:
        ...
        path_model_info = os.path.join(
            ABS_BASE_PATH, "..", "workdir_cristobal", "left_ventricle_model", "model_info.json"
        )
    ...
    if "BiVentricle" in models_to_run:
        # bi-ventricle model
        path_model_info = os.path.join(
            ABS_BASE_PATH, "..", "workdir_cristobal", "bi_ventricle_model", "model_info.json"
        )
        create_ls_dyna_files(path_model_info)
    ...
    if "FourChamber" in models_to_run:
        # four chamber model
        path_model_info = os.path.join(
            ABS_BASE_PATH, "..", "workdir_cristobal", "four_chamber_model", "model_info.json"
        )
        create_ls_dyna_files(path_model_info)
