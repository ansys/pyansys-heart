...
# NOTE: database append fails when trying to use dynalib.ansys.dyna.keywords.keyword_base import KeywordBase
# isinstance fails to recoqnize ContorlImplicitSolution_custom as a sub-class of KeywordBase
from ansys.dyna.keywords.card import Card, Field
from ansys.dyna.keywords.keyword_base import KeywordBase

class ControlImplicitSolution_custom(KeywordBase):
    ...
    @arcpsi.setter
    def arcpsi(self, value: int) -> None:
    ...
    @arcalf.setter
    def arcalf(self, value: int) -> None:
    ...
    @arctim.setter
    def arctim(self, value: int) -> None:
